...
**ステップ1: サーバーを起動**
ターミナルで以下のコマンドを実行してください。設定1から6までを指定できます。サーバーは指定された設定を `static/config.js` というファイルを動的に生成することで、ブラウザ側のシミュレーターに伝達します。
